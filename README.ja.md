...
> **ステータス (2026-09-19):** P1–P6 はリリース / サインオフ済みです。P6 では ARC + CompanyOS 向けのバージョン付き統合境界を追加し、最小化された投影/イベント、冪等な外部 DAG 送信、厳密なキャンセル、永続的な相関メタデータ、ARC 権限スモーク、および CompanyOS ゲートウェイ契約/動作証跡を提供します。
